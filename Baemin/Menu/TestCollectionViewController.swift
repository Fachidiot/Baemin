...
final class TestCollectionViewController: UICollectionViewController {
    ...
    init() {
        super.init(collectionViewLayout: TestCollectionViewController.createLayout())
    }
...
//                group.contentInsets.leading = 16
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(Header.self, forSupplementaryViewOfKind: TestCollectionViewController.categoryHeaderId, withReuseIdentifier: headerId)
    }
}
...
struct ContentView_Previews: PreviewProvider {
    ...
    struct Container: UIViewControllerRepresentable {
        func makeUIViewController(context: Context) -> UIViewController {
            UINavigationController(rootViewController: TestCollectionViewController())
        }
